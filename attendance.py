...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"collage_image\att1.jpg.jpg")
        ...
        #second image
        img1=Image.open(r"collage_image\att2.jpg.jpg")
        ...
        #background image
        img3=Image.open(r"collage_image\bg1.jpg.jpg")
        img3=img3.resize((1500,690),Image.ANTIALIAS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=180,width=1500,height=690)

        title_lbl=Label(bg_img,text="ATTENDANCE ",font=("times new roman",35,"bold"),bg="black",fg="white")
        ...
        img_left=Image.open(r"collage_image\details.jpg.jpg")
        ...
        left_inside_frame.place(x=0,y=100,width=654,height=330)
        ...
        attendanceId_entry=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_id,font=("times new roman",9,"bold"))   
        ...
        table_frame.place(x=5,y=5,width=660,height=430)
