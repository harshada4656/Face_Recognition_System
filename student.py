...
class Student:
    ...
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\hp\Desktop\face_recognition system\collage_image\stu1.jpg.jpg")
        ...
        #second image
        img1=Image.open(r"C:\Users\hp\Desktop\face_recognition system\collage_image\stu2.jpg.jpg")
        ...
        #third image
        img2=Image.open(r"C:\Users\hp\Desktop\face_recognition system\collage_image\stu3.jpg.png")
        ...
        bg_img.place(x=0,y=150,width=1500,height=710)
        ...
        main_frame.place(x=3,y=40,width=1500,height=600)
        ...
        img_left=Image.open(r"C:\Users\hp\Desktop\face_recognition system\collage_image\details.jpg.jpg")
        img_left=img_left.resize((720,130),Image.ANTIALIAS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(Left_frame,image=self.photoimg_left)
        f_lbl.place(x=3,y=0,width=720,height=100)

        #current course
        current_course_frame=LabelFrame(Left_frame,bd=2,relief=RIDGE,text="Current Course Details",font=("times new roman",12,"bold"))
        current_course_frame.place(x=5,y=100,width=650,height=90)
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new roman,",9,"bold"),state="readonly",width=20)
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("times new roman,",9,"bold"),state="readonly",width=20)
        ...
        semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman,",9,"bold"),state="readonly",width=20)
        ...
        class_student_frame.place(x=0,y=200,width=650,height=300) 
        ...
        div_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman,",9,"bold"),state="readonly",width=15)
        ...
        gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,font=("times new roman,",9,"bold"),state="readonly",width=15)
        ...
        phone_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone,width=20,font=("times new roman",9,"bold"))   
        ...
        take_photo_btn=Button(btn_frame,text="Take Photo Sample",command=self.generate_dataset,width=17,font=("times new roman",11,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=1,column=0)

        update_photo_btn=Button(btn_frame,text="Update Photo Sample",width=17,font=("times new roman",11,"bold"),bg="blue",fg="white")
        update_photo_btn.grid(row=1,column=1)

        
        #right label frame
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Right_frame.place(x=670,y=10,width=680,height=580)


        img_right=Image.open(r"C:\Users\hp\Desktop\face_recognition system\collage_image\stu.jpg.jpg")
        ...
        search_combo=ttk.Combobox(Search_frame,font=("times new roman,",9,"bold"),state="readonly",width=15)
        ...
        showAll_btn=Button(Search_frame,text="Show All",width=13,font=("times new roman",11,"bold"),bg="blue",fg="white")
        showAll_btn.grid(row=0,column=4,padx=4)

        #============table frame===========
        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=180,width=670,height=280)
